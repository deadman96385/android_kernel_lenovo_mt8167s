...
/* ----------------------------------------------------------------------------- */
#define SYSRAM_BASE_PHY_ADDR    ((0xF9000000&0x0FFFFFFF)|0x10000000) /* temp hard code */
...
/*  */
#define SYSRAM_USER_SIZE_VIDO   (SYSRAM_BASE_SIZE)	/* (78408)//(74496) */
