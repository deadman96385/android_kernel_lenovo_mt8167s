...
#define LOG_2 LOG_INF("preview/capture/vedio/slim_video/hs_video: 1280*960 560Mbps/lane 30fps\n")
/****************************   Modify end    *******************************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.pre = {
		.pclk = 55969920,	     /* record different mode's pclk */
		...
		.mipi_data_lp2hs_settle_dc = SETTLE_DELAY,	/* unit , ns, 20 */
		/*following for GetDefaultFramerateByScenario() */
		.max_framerate = 300,
		},
	.cap = {
		.pclk = 83954880,	   /* record different mode's pclk */
	...
	.hs_video = {
		.pclk = 84004800,	/* record different mode's pclk */
		.linelength  = 1892,	/*        //record different mode's linelength */
		.framelength =  740,	/*        //record different mode's framelength */
		.startx = 0,	/* record different mode's startx of grabwindow */
		.starty = 0,	/* record different mode's starty of grabwindow */
	...
	.slim_video = {
		.pclk = 84004800,	/* record different mode's pclk */
		.linelength = 1892,	/*        //record different mode's linelength */
		.framelength = 1480,	/*        //record different mode's framelength */
		.startx = 0,	/* record different mode's startx of grabwindow */
		.starty = 0,	/* record different mode's starty of grabwindow */
		.grabwindow_width = 1280,	/*         //record different mode's width of grabwindow */
		.grabwindow_height = 720,	/*       //record different mode's height of grabwindow */
	...
	.margin = 4,		/* check      //sensor framelength & shutter margin */
	...
	.mipi_lane_num = SENSOR_MIPI_2_LANE,	/* mipi lane num 1lane check */
...
static SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	{2624, 1956, 0,    2, 2624, 1952, 1312, 976,    8, 2, 1296, 972,  0, 0, 1296,  972},/* Preview */
	{2624, 1956, 0,    0, 2624, 1956, 2624, 1956,  160, 6, 2304, 1944, 0, 0, 2304, 1944},/* capture */
	{2624, 1956, 336, 432, 1952, 1092, 1952, 1092,  16, 6,   1920, 1080,   0, 0, 1920, 1080},/* video */
	{2624, 1956, 0,   250, 2624, 1456, 1312, 728, 16, 4, 1280, 720, 0, 0, 1280, 720},/* hs video */
	{2624, 1956, 0,   250, 2624, 1456, 1312, 728, 16, 4, 1280, 720, 0, 0, 1280, 720}	/* slim video */
};
...
static void set_dummy(void)
{
	...
	write_cmos_sensor(0x380c, imgsensor.line_length >> 8);	/* check */
...
{
	/* modify read id method,must write page first and then read the id */

	return ((read_cmos_sensor(0x300a) << 8) | read_cmos_sensor(0x300b));	/* check 5645 */
}
...
static void write_shutter(kal_uint16 shutter)
{
	...
	/* P1:0x03_0x04 will increase VBLANK to get exposure larger than frame exposure */
