...
/* export functions */
 /*SY*/ UINT32 IMX220_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT * pfFunc);
...
UINT32 IMX073_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
 /*OV*/ UINT32 OV16825MIPISensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
UINT32 OV2650SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
 /*SS*/ UINT32 S5K2P8_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
UINT32 S5K8AAYX_PVI_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
 /*HI*/ UINT32 HI841_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
UINT32 HI191MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
 /*MT*/ UINT32 MT9P012SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
UINT32 MT9V115_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
 /*GC*/ UINT32 GC2355_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
UINT32 GC0310_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
 /*SP*/ UINT32 SP0A19_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 SP2518_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
 /*A*/ UINT32 A5141_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 A5142_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
 /*HM*/ UINT32 HM3451SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
 /*AR*/ UINT32 AR0833_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
 /*SIV*/ UINT32 SIV120B_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
/* #define SP2509_MIPI_RAW */
	...
	{SP2518_YUV_SENSOR_ID, SENSOR_DRVNAME_SP2518_YUV, SP2518_YUV_SensorInit}
	,
#endif
	 /*A*/
