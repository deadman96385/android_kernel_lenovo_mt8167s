...
/*  if 0, means 2 lane */
/* Notice that: 2 lane may not working..*/
#define MIPI_4LANE			1
...
static SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = { {3280, 2464, 0, 0, 3280, 2464, 1640, 1232, 0, 0, 1640, 1232, 2, 2, 1632, 1224},	/* Preview */
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	if (gain != IMX219MIPI_sensorGainMapping[iI][0]) {
		LOG_INF("Gain mapping don't correctly:%d %d\n", gain,
			IMX219MIPI_sensorGainMapping[iI][0]);
	}
...
static void capture_setting(kal_uint16 currefps)
{
	...
	write_cmos_sensor(0x030B, 0x01);
	write_cmos_sensor(0x030C, 0x00);
	write_cmos_sensor(0x030D, 0x5A);	/* 0åx56, 0x54 */
	/* write_cmos_sensor(0x455E, 0x00); */
	/* write_cmos_sensor(0x471E, 0x4B); */
	write_cmos_sensor(0x4767, 0x0F);
	write_cmos_sensor(0x4750, 0x14);
