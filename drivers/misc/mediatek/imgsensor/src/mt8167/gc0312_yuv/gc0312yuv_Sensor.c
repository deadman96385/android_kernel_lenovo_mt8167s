...
*/
	...
	GC0312_write_cmos_sensor(0x2b, 0x05);	/* 7.14fps */
...
BOOL GC0312_set_param_banding(UINT16 para)
{
	...
	case AE_FLICKER_MODE_60HZ:
		...
		GC0312_write_cmos_sensor(0xfe, 0x01);
		GC0312_write_cmos_sensor(0x25, 0x00);	/* anti-flicker step [11:8] */
		GC0312_write_cmos_sensor(0x26, 0x60);	/* anti-flicker step [7:0] */

		GC0312_write_cmos_sensor(0x27, 0x02);	/* exp level 0  20fps */
		GC0312_write_cmos_sensor(0x28, 0x40);
		GC0312_write_cmos_sensor(0x29, 0x03);	/* exp level 1  13fps */
		GC0312_write_cmos_sensor(0x2a, 0x60);
		GC0312_write_cmos_sensor(0x2b, 0x06);	/* exp level 2  7.5fps */
		GC0312_write_cmos_sensor(0x2c, 0x00);
		GC0312_write_cmos_sensor(0x2d, 0x08);	/* exp level 3  5.45fps */
