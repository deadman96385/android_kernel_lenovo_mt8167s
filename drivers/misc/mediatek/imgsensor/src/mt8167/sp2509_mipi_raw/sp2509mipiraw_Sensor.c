...
#define LOG_2 LOG_INF("preview 1600*1200@30fps,864Mbps/lane\n")
/****************************   Modify end    *******************************************/
...
static imgsensor_info_struct imgsensor_info = {
	...
	//modify by zhangziran@huaqin.com to change color of camera start on 19.08.06
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x3f, 0x01);	/* sanford.lin mirror */
	//modify by zhangziran@huaqin.com end
	write_cmos_sensor(0x44, 0x00);
