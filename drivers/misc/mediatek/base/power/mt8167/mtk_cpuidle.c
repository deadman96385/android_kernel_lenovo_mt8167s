...
{
	kp_irq_bit = get_dts_node_irq_bit("mediatek,mt8167-keypad", 3, 0);
	conn_wdt_irq_bit = get_dts_node_irq_bit("mediatek,mt8167-consys", 6, 3);
	lowbattery_irq_bit = get_dts_node_irq_bit("mediatek,mt8167-auxadc", 3, 0);
}
