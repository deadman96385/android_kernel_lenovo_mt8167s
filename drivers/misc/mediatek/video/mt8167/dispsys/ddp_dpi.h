...
/* for legacy DPI Driver */
	...
	enum DPI_VIDEO_RESOLUTION {
		DPI_VIDEO_720x480i_60Hz = 0,/* 0 */
		DPI_VIDEO_720x576i_50Hz,	/* 1 */
		DPI_VIDEO_720x480p_60Hz,	/* 2 */
		DPI_VIDEO_720x576p_50Hz,	/* 3 */
		DPI_VIDEO_1280x720p_60Hz,	/* 4 */
		DPI_VIDEO_1280x720p_50Hz,	/* 5 */
		DPI_VIDEO_1920x1080i_60Hz,	/* 6 */
		DPI_VIDEO_1920x1080i_50Hz,	/* 7 */
		DPI_VIDEO_1920x1080p_30Hz,	/* 8 */
		DPI_VIDEO_1920x1080p_25Hz,	/* 9 */
		DPI_VIDEO_1920x1080p_24Hz,	/* 10 */
		DPI_VIDEO_1920x1080p_23Hz,	/* 11 */
		DPI_VIDEO_1920x1080p_29Hz,	/* 12 */
		DPI_VIDEO_1920x1080p_60Hz,	/* 13 */
		DPI_VIDEO_1920x1080p_50Hz,	/* 14 */

		DPI_VIDEO_1280x720p3d_60Hz,	/* 15 */
		DPI_VIDEO_1280x720p3d_50Hz,	/* 16 */
		DPI_VIDEO_1920x1080i3d_60Hz,	/* 17 */
		DPI_VIDEO_1920x1080i3d_50Hz,	/* 18 */
		DPI_VIDEO_1920x1080p3d_24Hz,	/* 19 */
		DPI_VIDEO_1920x1080p3d_23Hz,	/* 20 */

		/*the 2160 mean 3840x2160 */
		DPI_VIDEO_2160P_23_976HZ,	/* 21 */
		DPI_VIDEO_2160P_24HZ,	/* 22 */
		DPI_VIDEO_2160P_25HZ,	/* 23 */
		DPI_VIDEO_2160P_29_97HZ,	/* 24 */
		DPI_VIDEO_2160P_30HZ,	/* 25 */
		/*the 2161 mean 4096x2160 */
		DPI_VIDEO_2161P_24HZ,	/* 26 */
