...
#define IRRX_ICLR_MASK           ((u32)1<<7)
#define IRRX_ICLR_OFFSET         ((u32)7)

#define IRRX_DGDEL_MASK          ((u32)3<<8)
...
#define IRRX_WDTSET                 0x00d4
#define IRRX_WDT                    0x00d8

#define IRRX_WDTLMT                 0x00dc
