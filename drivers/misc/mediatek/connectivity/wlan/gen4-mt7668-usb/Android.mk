...
include $(CLEAR_VARS)
LOCAL_MODULE := wlan_drv_gen4_mt7668_usb.ko
...
#$(LOCAL_BUILT_MODULE): $(LOCAL_GENERATED_SOURCES) $(KERNEL_ZIMAGE_OUT) $(LOCAL_EXPORT_SYMBOL) $(LOCAL_SRC_EXPORT_SYMBOL) $(AUTO_CONF) $(AUTOCONF_H) 
$(LOCAL_BUILT_MODULE): $(LOCAL_GENERATED_SOURCES) $(KERNEL_ZIMAGE_OUT) $(AUTO_CONF) $(AUTOCONF_H) 
	@echo $@: $^
