...
#endif
	{USB_DEVICE_AND_INTERFACE_INFO(0x043E, 0x3109, 0xe0, 0x01, 0x01), .bInterfaceNumber = 0},
	{USB_DEVICE_AND_INTERFACE_INFO(0x3109, 0x043E, 0xe0, 0x01, 0x01), .bInterfaceNumber = 0},
	{}
};
