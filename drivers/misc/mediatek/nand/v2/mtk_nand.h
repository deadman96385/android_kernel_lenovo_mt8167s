...
#define ECC_ENCPAR27_REG32   ((volatile unsigned int *)(NFIECC_BASE+0x0300))
#define ECC_ENCPAR34_REG32   ((volatile unsigned int *)(NFIECC_BASE+0x031C))
...
#define ECC_DECEL30_REG32    ((volatile unsigned int *)(NFIECC_BASE+0x0400))
#define ECC_DECEL39_REG32    ((volatile unsigned int *)(NFIECC_BASE+0x0424))
