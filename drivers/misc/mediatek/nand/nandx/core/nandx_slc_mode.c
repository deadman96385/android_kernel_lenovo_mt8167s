...
static void slc_mode_none(struct nandx_chip *chip)
{
}
...
static void slc_mode_feature_micron_entry(struct nandx_chip *chip)
{
	...
	/* TODO: for 0x91 */
	nandx_chip_set_feature_with_check(chip, 0x91, param, backp, 4);
}
