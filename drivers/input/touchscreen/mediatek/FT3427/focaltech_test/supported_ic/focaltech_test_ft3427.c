...
static int start_test_ft5422(void)
{
    ...
    if (true == test_item->rawdata_test) {
        ...
        if ((ret < 0) || (false == temp_result)) {
            test_result = false;
			test_data.test_item[FT3427_RAWDATA_TEST].testresult = RESULT_NG;
        }
		else
			{
            test_data.test_item[FT3427_RAWDATA_TEST].testresult= RESULT_PASS;
		    }
    }
    ...
    if (true == test_item->scap_cb_test) {
        ...
        if ((ret < 0) || (false == temp_result)) {
            test_result = false;
			test_data.test_item[FT3427_SCAP_CB_TEST].testresult  = RESULT_NG;
        }
		else
			{
			test_data.test_item[FT3427_SCAP_CB_TEST].testresult = RESULT_PASS;
			}
    }
    ...
    if (true == test_item->scap_rawdata_test) {
        ...
        if ((ret < 0) || (false == temp_result)) {
            test_result = false;
			test_data.test_item[FT3427_SCAP_RAWDATA_TEST].testresult = RESULT_NG;
        }
		else
			{
			test_data.test_item[FT3427_SCAP_RAWDATA_TEST].testresult = RESULT_PASS;
			}
    }
    ...
    if (true == test_item->short_test) {
        ...
        if ((ret < 0) || (false == temp_result)) {
            test_result = false;
			test_data.test_item[FT3427_WEAK_SHORT_CIRCUIT_TEST].testresult = RESULT_NG;
        }
		else

			{
			test_data.test_item[FT3427_WEAK_SHORT_CIRCUIT_TEST].testresult = RESULT_PASS;
			}
    }
    ...
    if (true == test_item->panel_differ_test) {
        ...
        if ((ret < 0) || (false == temp_result)) {
            test_result = false;
			test_data.test_item[FT3427_PANELDIFFER_TEST].testresult = RESULT_NG;
        
        }
		else
			{
			test_data.test_item[FT3427_PANELDIFFER_TEST].testresult = RESULT_PASS;
			}
    }
