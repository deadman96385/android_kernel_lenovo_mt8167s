...
#ifdef CONFIG_OF
static const struct of_device_id gt9xx_dt_match[] = { {.compatible = "mediatek,GT9XX_MTK"}, {},};
#endif
...
static int tpd_irq_registration(void)
{
	...
	node = of_find_compatible_node(NULL, NULL, "mediatek,GT9XX_MTK");//0704
